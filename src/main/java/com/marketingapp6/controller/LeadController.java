...
import com.marketingapp6.controller.LeadController;
import com.marketingapp6.controller.LeadDto;
import com.marketingapp6.service.LeadService;
import com.marketingapp6.service.LeadServiceImpl;
...
public class LeadController {
	...
	// @modelttribute will copy the data from form to entity object
	// instence of ModelMap we can use Model (its depends on our

	@RequestMapping("/saveLead")
	public String saveLead(@ModelAttribute Lead lead, ModelMap model) {
		leadService.saveLead(lead);
		emailService.sendEmail(lead.getEmail(), "Text", "welcome");
		model.addAttribute("msg", "recoured is seved");
		return "create_lead";
...
//	}
	...
	public String deleteLeaById(@RequestParam("id") long id, Model model) {
